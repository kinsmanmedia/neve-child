<?php
/**
 * Custom Header Template for Neve Child Theme
 *
 * This replaces the parent theme's header with a custom implementation
 * for the Mississauga Arts Council
 *
 * @package Neve Child
 * @since   1.0.0
 */
